...
async def download(event):
	...
	try:
		...
		downloaded_file_name = await borg.download_media(
			...
			progress(d, t, mone, c_time, "**__trying to download__**")
			)
		)
		...
		await event.delete()
		await mone.edit("**__Downloaded to `{}` in {} seconds.__**".format(downloaded_file_name, ms))
		await mone.edit("**__Committing to Github....__**")
...
async def git_commit(file_name,mone):
	...
	if create_file == True:
		...
		try:
			...
			await mone.edit("**__Committed on Your Github Repo.__**\n\nLink: `" + link + "`\n\nRAW Link: `" + rawlink + "`")
		except:
